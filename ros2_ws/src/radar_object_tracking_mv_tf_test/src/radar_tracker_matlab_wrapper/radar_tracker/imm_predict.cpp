  ...
  if (std::abs(dt) > 0.0) {
    for (int imm_idx = 0; imm_idx < 3; imm_idx++) {
      if (imm_idx + 1 == 1) {
        ...
        if (std::abs(obj->IMM[imm_idx].x[3]) >0) {//lnl, 0
        ...
        //lnl,  brake to stop 
        // std::cout<<" 0X_imm_predict,before predict"<<" obj->IMM["<<imm_idx<<"].x[0]: "<<obj->IMM[imm_idx].x[0]<<" obj->IMM["<<imm_idx<<"].x[1]: "<<obj->IMM[imm_idx].x[1]<<" obj->IMM["<<imm_idx<<"].x[2]: "<<obj->IMM[imm_idx].x[2]<<" dt: "<<dt<<std::endl;


        //  state-prediction
        if (obj->standing > 0.5)// || std::abs(obj->IMM[imm_idx].x[3])<0.1) {  //obj->standing > 0.5  std::abs(obj->IMM[imm_idx].x[3])<0.1
        {
          ...
          //lnl,  brake to stop 
          // std::cout<<"0_imm_predict, linear motion "<<std::endl;
        }
        else {
          ...
          //lnl,  brake to stop 
          // std::cout<<"0_imm_predict, constant turn rate "<<std::endl;
          // std::cout<<"0_imm_predict: "<<"std::abs(obj->IMM["<<imm_idx<<"].x[3]: "<<std::abs(obj->IMM[imm_idx].x[3])<<"SW: "<<SW<<" CW: "<<CW<<std::endl;
        }
        //lnl,  brake to stop 
        // std::cout<<"0_imm_predict, standing, moving: "<<obj->standing<<" "<<obj->moving<<" "<<std::endl;
        // std::cout<<" 0_imm_predict,"<<" obj->IMM["<<imm_idx<<"].x[0]: "<<obj->IMM[imm_idx].x[0]<<" obj->IMM["<<imm_idx<<"].x[1]: "<<obj->IMM[imm_idx].x[1]<<" obj->IMM["<<imm_idx<<"].x[2]: "<<obj->IMM[imm_idx].x[2]<<" "<<std::endl;
        ...
        //lnl, brake to stop
        // std::cout<<" 0_imm_predict: obj->IMM[1].x[5] vy: "<<imm_idx<<" "<<obj->IMM[imm_idx].x[5]<<" "<<std::endl;
        // std::cout<<" 0_imm_predict: obj->IMM[1].x[6] vy: "<<imm_idx<<" "<<obj->IMM[imm_idx].x[6]<<" "<<std::endl;
        //  state prediction
        for (i = 0; i < 6; i++) {
          BW = 0.0;
          for (i1 = 0; i1 < 6; i1++) {
        ...
        for (i = 0; i < 6; i++) {
          ...
          //lnl, brake to stop
          // std::cout<<" 0_imm_predict: obj->IMM[1].x[0, 1, 2 ...]: "<<imm_idx<<" "<<obj->IMM[imm_idx].x[i]<<" "<<std::endl;
        }
        ...
        //lnl, brake to stop
        // std::cout<<" 0_imm_predict: obj->IMM[2].x[5] vy: "<<imm_idx<<" "<<obj->IMM[imm_idx].x[5]<<" "<<std::endl;
        // std::cout<<" 0_imm_predict: obj->IMM[2].x[6] vy: "<<imm_idx<<" "<<obj->IMM[imm_idx].x[6]<<" "<<std::endl;
        ...
        for (i = 0; i < 6; i++) {
          obj->IMM[imm_idx].x[i] = c_A[i];
          //lnl, brake to stop
          // std::cout<<" 0_imm_predict: obj->IMM[2].x[0, 1, 2 ...]: "<<imm_idx<<" "<<obj->IMM[imm_idx].x[i]<<" "<<std::endl;
        }
