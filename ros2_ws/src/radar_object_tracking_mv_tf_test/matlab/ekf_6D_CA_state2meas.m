function measurement = ekf_6D_CA_state2meas(state_vector, sens_offset_x, sens_offset_y, vx_ego) %#codegen
...
py_sensor = state_vector(4) - sens_offset_y; 

range = sqrt(px_sensor.^2 + py_sensor.^2);

vx_sensor = state_vector(2) - vx_ego;  % x-velocity in sensor coordinate system
vy_sensor = state_vector(5);           % y-velocity in sensor coordinate system
