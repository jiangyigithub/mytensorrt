...
public:
   ...
   */
   ...
   bool isMdThetaIndcrSIMOVld() const { return (mdThetaIndcrSIMOVldFlg == (vfc::uint8_t) RCI_INDCR_VALID); }
   /*! \brief getter function for mdThetaIndcrMIMO indicator validity flag */
   bool isMdThetaIndcrMIMOVld() const { return (mdThetaIndcrMIMOVldFlg == (vfc::uint8_t) RCI_INDCR_VALID); }
   /*! \brief getter function for mdThetaSIMOShare indicator validity flag */
   bool isMdThetaSIMOShareVld() const { return (mdThetaSIMOShareVldFlg == (vfc::uint8_t) RCI_INDCR_VALID); }
   /*! \brief getter function for mdThetaMIMOShare indicator validity flag */
   bool isMdThetaMIMOShareVld() const { return (mdThetaMIMOShareVldFlg == (vfc::uint8_t) RCI_INDCR_VALID); }
