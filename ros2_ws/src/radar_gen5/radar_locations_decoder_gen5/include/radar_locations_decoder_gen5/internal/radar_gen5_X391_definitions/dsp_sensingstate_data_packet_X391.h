...
public:
   ...
   DSP_MISALIGNMENT_ST() : thetaMalAng(0.0F), thetaMalAngVar(0.0F),
         ...
         minThetaMalSOs(0.0F), maxThetaMalSOs(0.0F), varThetaMalSOs(0.0F), meanThetaMalSOs(0.0F),
         minPhiMalSOs(0.0F), maxPhiMalSOs(0.0F), varPhiMalSOs(0.0F), meanPhiMalSOs(0.0F), spreadPhiMalSOs(0.0F), numSOs(0U), numEmeLocs(0U)
   { };
   ...
   * \endverbatim
   */
   vfc::float16_storage_t minThetaMalSOs;
   /**
   ...
   * \endverbatim
   */
   vfc::float16_storage_t maxThetaMalSOs;
   /**
   ...
   * \endverbatim
   */
   vfc::float16_storage_t varThetaMalSOs;
   /**
   ...
   * \endverbatim
   */
   vfc::float16_storage_t meanThetaMalSOs;
   /**
   ...
   * \endverbatim
   */
   vfc::float16_storage_t minPhiMalSOs;
   /**
   ...
   * \endverbatim
   */
   vfc::float16_storage_t maxPhiMalSOs;
   /**
   ...
   * \endverbatim
   */
   vfc::float16_storage_t varPhiMalSOs;
   /**
   ...
   * \endverbatim
   */
   vfc::float16_storage_t meanPhiMalSOs;
   /**
   ...
   * \endverbatim
   */
   vfc::float16_storage_t spreadPhiMalSOs;
   /**
...
enum ValidFlgState
{
   ...
   RCI_INDCR_INVALID = 0,
   //! radar coating indicator status = unknown
   RCI_INDCR_UNKNOWN = 128,
...
public:
   // Constructor
   DSP_BLINDNESS_ST() :
      mdThetaIndcrSIMO(0.F),
      mdThetaIndcrMIMO(0.F),
      mdThetaSIMOShare(0.F),
      mdThetaMIMOShare(0.F),
      mdThetaIndcr(0.F),
      mdPhiIndcr(0.F),
      mdRCSIndcrMO(0.F),
      ...
      spectralMax(0.F),
      nBinsOverDetThdIndcrFOV0(0.F),
      nBinsOverDetThdIndcrFOV1(0.F),
      treeResult(0.F),
      mdThetaIndcrSIMOVldFlg(0U),
      mdThetaIndcrMIMOVldFlg(0U),
      mdThetaSIMOShareVldFlg(0U),
      mdThetaMIMOShareVldFlg(0U),
      ...
      spectralMaxVldFlg(0U),
      nBinsOverDetThdIndcrFOV0VldFlg(0U),
      nBinsOverDetThdIndcrFOV1VldFlg(0U),
      treeResultVldFlg(0U)
   { };

   /**
    * \brief azimuth angle fit one target model deviation of SIMO angles
    *       value range: [0 1]
    * \verbatim
    *       phys. unit: -
    * \endverbatim
   */
   vfc::float16_storage_t mdThetaIndcrSIMO;
   /**
    * \brief Azimuth angle fit one target model deviation of MIMO angles
    *       value range: [0 1]
    * \verbatim
    *       phys. unit: -
    * \endverbatim
   */
   vfc::float16_storage_t mdThetaIndcrMIMO;
   /**
    * \brief share of very high SIMO angle qualities in one cycle
    *       value range: [0 1]
    * \verbatim
    *       phys. unit: -
    * \endverbatim
   */
   vfc::float16_storage_t mdThetaSIMOShare;
   /**
    * \brief share of very high MIMO angle qualities in one cycle
    *       value range: [0 1]
    * \verbatim
    *       phys. unit: -
    * \endverbatim
   */
   vfc::float16_storage_t mdThetaMIMOShare;
   /**
   ...
   */
   ...
   /**
   * \brief Maximum power in the log2 power spectra
   *       Norm: []
   * \verbatim
   *       phys. unit: -
   * \endverbatim
   */
   vfc::float16_storage_t spectralMax;
   /**
   * \brief  Number of bins over detection threshold for FOV0
   *       Norm: []
   * \verbatim
   *       phys. unit: -
   * \endverbatim
   */
   vfc::float16_storage_t nBinsOverDetThdIndcrFOV0;
   /**
   * \brief  Number of bins over detection threshold for FOV1
   *       Norm: []
   * \verbatim
   *       phys. unit: -
   * \endverbatim
   */
   vfc::float16_storage_t nBinsOverDetThdIndcrFOV1;
   /**
   * \brief  tree based blindness decision
   *       Norm: []
   * \verbatim
   *       phys. unit: -
   * \endverbatim
   */
   vfc::float16_storage_t treeResult;
   /**
    * \brief validity flag for mdThetaIndcrSIMO
    *       0   = indicator invalid
   *        255 = indicator valid
    * \verbatim
    *       phys. unit: -
    * \endverbatim
   */
   vfc::uint8_t mdThetaIndcrSIMOVldFlg;
   /**
    * \brief validity flag for mdThetaIndcrMIMO
    *       value = min(255, used reflection count)
    *       0:  indicator invalid
    *       1..255: indicator valid
    * \verbatim
    *       phys. unit: -
    * \endverbatim
   */
   vfc::uint8_t mdThetaIndcrMIMOVldFlg;
   /**
    * \brief validity flag for mdThetaSIMOShare
    *       value = min(255, used reflection count)
    *       0:  indicator invalid
    *       1..255: indicator valid
    * \verbatim
    ...
    * \endverbatim
   */
   vfc::uint8_t mdThetaSIMOShareVldFlg;
   /**
    * \brief validity flag for mdThetaMIMOShare
    *       value = min(255, used reflection count)
    *       0:  indicator invalid
    *       1..255: indicator valid
    * \verbatim
    ...
    * \endverbatim
   */
   vfc::uint8_t mdThetaMIMOShareVldFlg;
   /**
   ...
   */
    ...
    *       value = min(255, total number of reflections)
    *       0:  indicator invalid
    *       1..255: indicator valid
    * \verbatim
    *       phys. unit: -
   ...
   */
   ...
   /**
   * \brief validity flag for spectralMax
   *        0   = indicator invalid
   *     255 = indicator valid
   * \verbatim
   *       phys. unit: -
   * \endverbatim
   */
   vfc::uint8_t spectralMaxVldFlg;
   /**
   * \brief validity flag for nBinsOverDetThdIndcrFOV0
   *       0   = indicator invalid
   *       255 = indicator valid
   * \verbatim
   *       phys. unit: -
   * \endverbatim
   */
   vfc::uint8_t nBinsOverDetThdIndcrFOV0VldFlg;
   /**
   * \brief validity flag for nBinsOverDetThdIndcrFOV1
   *       0   = indicator invalid
   *       255 = indicator valid
   * \verbatim
   *       phys. unit: -
   * \endverbatim
   */
   vfc::uint8_t nBinsOverDetThdIndcrFOV1VldFlg;
   /**
   * \brief validity flag for treeResult
   *       0   = indicator invalid
   *       255 = indicator valid
   * \verbatim
   *       phys. unit: -
   * \endverbatim
   */
   vfc::uint8_t treeResultVldFlg;

   /*! \brief getter function for mdThetaIndcrSIMO indicator */
   vfc::float32_t getMdThetaIndcrSIMO() const { return (vfc::float32_t)mdThetaIndcrSIMO; }
   /*! \brief getter function for mdThetaIndcrMIMO indicator */
   vfc::float32_t getMdThetaIndcrMIMO() const { return (vfc::float32_t)mdThetaIndcrMIMO; }
   /*! \brief getter function for mdThetaSIMOShare indicator */
   vfc::float32_t getMdThetaSIMOShare() const { return (vfc::float32_t)mdThetaSIMOShare; }
   /*! \brief getter function for mdThetaMIMOShare indicator */
   vfc::float32_t getMdThetaMIMOShare() const { return (vfc::float32_t)mdThetaMIMOShare; }
   /*! \brief getter function for mdThetaIndcr indicator */
   ...
   /*! \brief getter function for spectralMax indicator */
   vfc::float32_t getSpectralMax() const { return (vfc::float32_t)spectralMax; }
   /*! \brief getter function for nBinsOverDetThdIndcrFOV0 indicator */
   vfc::float32_t getNBinsOverDetThdIndcrFOV0() const { return (vfc::float32_t)nBinsOverDetThdIndcrFOV0; }
   /*! \brief getter function for nBinsOverDetThdIndcrFOV1 indicator */
   vfc::float32_t getNBinsOverDetThdIndcrFOV1() const { return (vfc::float32_t)nBinsOverDetThdIndcrFOV1; }
   /*! \brief getter function for treeResult */
    vfc::float32_t getTreeResult() const { return (vfc::float32_t)treeResult; }     

   /*! \brief getter function for mdThetaIndcrSIMO indicator validity flag */
   bool isMdThetaIndcrSIMOVld() const { return (mdThetaIndcrSIMOVldFlg > (vfc::uint8_t) RCI_INDCR_INVALID); }
   /*! \brief getter function for mdThetaIndcrMIMO indicator validity flag */
   bool isMdThetaIndcrMIMOVld() const { return (mdThetaIndcrMIMOVldFlg > (vfc::uint8_t) RCI_INDCR_INVALID); }
   /*! \brief getter function for mdThetaSIMOShare indicator validity flag */
   bool isMdThetaSIMOShareVld() const { return (mdThetaSIMOShareVldFlg > (vfc::uint8_t) RCI_INDCR_INVALID); }
   /*! \brief getter function for mdThetaMIMOShare indicator validity flag */
   bool isMdThetaMIMOShareVld() const { return (mdThetaMIMOShareVldFlg > (vfc::uint8_t) RCI_INDCR_INVALID); }
   /*! \brief getter function for mdThetaIndcr indicator validity flag */
   bool isMdThetaIndcrVld() const { return (mdThetaIndcrVldFlg > (vfc::uint8_t) RCI_INDCR_INVALID); }
   /*! \brief getter function for mdPhiIndcr indicator validity flag */
   bool isMdPhiIndcrVld() const { return (mdPhiIndcrVldFlg > (vfc::uint8_t) RCI_INDCR_INVALID); }
   ...
   bool isNRefIndcrVld() const { return (nRefIndcrVldFlg > (vfc::uint8_t) RCI_INDCR_INVALID); }
   /*! \brief getter function for mdCrossCorrIndcrSO indicator validity flag */
   bool isMdCrossCorrIndcrSOVld() const { return (mdCrossCorrIndcrSOVldFlg != (vfc::uint8_t) RCI_INDCR_UNKNOWN); }
   /*! \brief getter function for spectralMax indicator validity flag */
   bool isSpectralMaxVld() const { return (spectralMaxVldFlg == (vfc::uint8_t) RCI_INDCR_VALID); }
   /*! \brief getter function for nBinsOverDetThdIndcrFOV0 indicator validity flag */
   bool isNBinsOverDetThdIndcrFOV0Vld() const { return (nBinsOverDetThdIndcrFOV0VldFlg == (vfc::uint8_t) RCI_INDCR_VALID); }
   /*! \brief getter function for nBinsOverDetThdIndcrFOV1 indicator validity flag */
   bool isNBinsOverDetThdIndcrFOV1Vld() const { return (nBinsOverDetThdIndcrFOV1VldFlg == (vfc::uint8_t) RCI_INDCR_VALID); }
   /*! \brief getter function for treeResult validity flag */
   bool isTreeResultVld() const { return (treeResultVldFlg == (vfc::uint8_t) RCI_INDCR_VALID);}
