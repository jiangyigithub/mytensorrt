...
public:
	...
	DSP_BLINDNESS_ST() : mdThetaIndcrSO(0), mdThetaIndcrMO(0), mdPhiIndcr(0), mdRCSIndcrMO(0),
	      nBinsOverDetThdIndcr(0), nRefIndcr(0), mdCrossCorrIndcrSO(0), mdThetaIndcrSOVldFlg(0), mdThetaIndcrMOVldFlg(0),
	      mdPhiIndcrVldFlg(0), mdRCSIndcrMOVldFlg(0), nBinsOverDetThdIndcrVldFlg(0), nRefIndcrVldFlg(0), mdCrossCorrIndcrSOVldFlg(0)
	{ };
   ...
   */
    ...
    *       phys. unit: -
    * \endverbatim
   */   vfc::uint16_t mdCrossCorrIndcrSO;
   /**
   ...
   */
    ...
    *       phys. unit: -
    * \endverbatim
   */   vfc::uint16_t mdCrossCorrIndcrSOVldFlg;
};
