...
#include <radar_locations_decoder_gen5/internal/radar_gen5_X167_definitions/dsp_LocationInterface_X167.hpp>

namespace radar_locations_decoder_gen5 {


RadarLocationDataGen5 RadarLocationsDecoderImplX167::decodeROBs(const uint8_t *data) const
{
    const X167::Dsp::LocationInterface *buf_dsp_location_data_p = (const X167::Dsp::LocationInterface *)data;
