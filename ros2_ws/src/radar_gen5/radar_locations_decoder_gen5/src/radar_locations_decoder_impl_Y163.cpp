...
#include <radar_locations_decoder_gen5/internal/radar_gen5_Y163_definitions/dsp_LocationInterface_Y163.hpp>

namespace radar_locations_decoder_gen5 {


RadarLocationDataGen5 RadarLocationsDecoderImplY163::decodeROBs(const uint8_t *data) const
{
    const Y163::Dsp::LocationInterface *buf_dsp_location_data_p = (const Y163::Dsp::LocationInterface *)data;
