...
#include <radar_locations_decoder_gen5/internal/radar_gen5_B167_local_definitions/dsp_LocationInterface_B167_local.hpp>

namespace radar_locations_decoder_gen5 {


RadarLocationDataGen5 RadarLocationsDecoderImplB167Local::decodeROBs(const uint8_t *data) const
{
    const B167_local::Dsp::LocationInterface *buf_dsp_location_data_p = (const B167_local::Dsp::LocationInterface *)data;
