...
#include <radar_locations_decoder_gen5/internal/radar_gen5_X171_DV1_local_definitions/dsp_LocationInterface_X171_DV1_local.hpp>

namespace radar_locations_decoder_gen5 {


RadarLocationDataGen5 RadarLocationsDecoderImplX171DV1Local::decodeROBs(const uint8_t *data) const
{
    const X171_DV1_local::Dsp::LocationInterface *buf_dsp_location_data_p = (const X171_DV1_local::Dsp::LocationInterface *)data;
