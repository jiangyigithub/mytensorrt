...
#include <radar_locations_decoder_gen5/internal/radar_gen5_X123_definitions/dsp_LocationInterface_X123.hpp>

namespace radar_locations_decoder_gen5 {


RadarLocationDataGen5 RadarLocationsDecoderImplX123::decodeROBs(const uint8_t *data) const
{
  const X123::Dsp::LocationInterface *buf_dsp_location_data_p = (const X123::Dsp::LocationInterface *)data;
