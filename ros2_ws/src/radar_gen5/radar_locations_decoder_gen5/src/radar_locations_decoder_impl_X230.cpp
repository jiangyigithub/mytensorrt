...
#include <radar_locations_decoder_gen5/internal/radar_gen5_X230_definitions/dsp_LocationInterface_X230.hpp>

namespace radar_locations_decoder_gen5 {


RadarLocationDataGen5 RadarLocationsDecoderImplX230::decodeROBs(const uint8_t *data) const
{
    const X230::Dsp::LocationInterface *buf_dsp_location_data_p = (const X230::Dsp::LocationInterface *)data;
