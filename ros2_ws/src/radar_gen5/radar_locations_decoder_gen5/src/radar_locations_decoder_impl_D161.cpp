...
#include <radar_locations_decoder_gen5/internal/radar_gen5_D161_definitions/dsp_LocationInterface_D161.hpp>

namespace radar_locations_decoder_gen5 {


RadarLocationDataGen5 RadarLocationsDecoderImplD161::decodeROBs(const uint8_t *data) const
{
    const D161::Dsp::LocationInterface *buf_dsp_location_data_p = (const D161::Dsp::LocationInterface *)data;
