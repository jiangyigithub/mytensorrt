...
#include <radar_locations_decoder_gen5/internal/radar_gen5_X170_definitions/dsp_LocationInterface_X170.hpp>

namespace radar_locations_decoder_gen5 {


RadarLocationDataGen5 RadarLocationsDecoderImplX170::decodeROBs(const uint8_t *data) const
{
    const X170::Dsp::LocationInterface *buf_dsp_location_data_p = (const X170::Dsp::LocationInterface *)data;
