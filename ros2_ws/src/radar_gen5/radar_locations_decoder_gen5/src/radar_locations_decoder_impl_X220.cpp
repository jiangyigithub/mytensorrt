...
#include <radar_locations_decoder_gen5/internal/radar_gen5_X220_definitions/dsp_LocationInterface_X220.hpp>

namespace radar_locations_decoder_gen5 {


RadarLocationDataGen5 RadarLocationsDecoderImplX220::decodeROBs(const uint8_t *data) const
{
    const X220::Dsp::LocationInterface *buf_dsp_location_data_p = (const X220::Dsp::LocationInterface *)data;
