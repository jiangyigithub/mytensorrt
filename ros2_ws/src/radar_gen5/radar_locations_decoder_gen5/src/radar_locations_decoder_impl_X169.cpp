...
#include <radar_locations_decoder_gen5/internal/radar_gen5_X169_definitions/dsp_LocationInterface_X169.hpp>

namespace radar_locations_decoder_gen5 {


RadarLocationDataGen5 RadarLocationsDecoderImplX169::decodeROBs(const uint8_t *data) const
{
    const X169::Dsp::LocationInterface *buf_dsp_location_data_p = (const X169::Dsp::LocationInterface *)data;
