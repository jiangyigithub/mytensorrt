...
#include <radar_locations_decoder_gen5/internal/radar_gen5_X168_local_definitions/dsp_LocationInterface_X168_local.hpp>

namespace radar_locations_decoder_gen5 {


RadarLocationDataGen5 RadarLocationsDecoderImplX168Local::decodeROBs(const uint8_t *data) const
{
    const X168_local::Dsp::LocationInterface *buf_dsp_location_data_p = (const X168_local::Dsp::LocationInterface *)data;
