...
#include <radar_locations_decoder_gen5/internal/radar_gen5_RC18041_definitions/dsp_LocationInterface_RC18041.hpp>

namespace radar_locations_decoder_gen5 {


RadarLocationDataGen5 RadarLocationsDecoderImplRC18041::decodeROBs(const uint8_t *data) const
{
  const RC18041::Dsp::LocationInterface *buf_dsp_location_data_p = (const RC18041::Dsp::LocationInterface *)data;
  ...
  for (size_t locIdx = 0; locIdx < location_list.getNumberOfLocations(); locIdx++)
  {
      ...
      item_curr.radial_distance_spread = dsp_loc_item.getRadialDistanceSpread();
      item_curr.relative_radial_velocity_spread = dsp_loc_item.getRelativeRadialVelocitySpread();
      item_curr.distance_velocity_spread_orientation = dsp_loc_item.getDistanceVelocitySpreadOrientation();
