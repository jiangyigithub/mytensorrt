...
#include <radar_locations_decoder_gen5/internal/radar_gen5_X173_definitions/dsp_LocationInterface_X173.hpp>

namespace radar_locations_decoder_gen5 {


RadarLocationDataGen5 RadarLocationsDecoderImplX173::decodeROBs(const uint8_t *data) const
{
    const X173::Dsp::LocationInterface *buf_dsp_location_data_p = (const X173::Dsp::LocationInterface *)data;
