...
#include <radar_locations_decoder_gen5/internal/radar_gen5_X151_definitions/dsp_LocationInterface_X151.hpp>

namespace radar_locations_decoder_gen5 {


RadarLocationDataGen5 RadarLocationsDecoderImplX151::decodeROBs(const uint8_t *data) const
{
  const X151::Dsp::LocationInterface *buf_dsp_location_data_p = (const X151::Dsp::LocationInterface *)data;
