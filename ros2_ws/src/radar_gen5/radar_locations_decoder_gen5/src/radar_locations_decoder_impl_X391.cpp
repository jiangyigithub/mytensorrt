...
#include <radar_locations_decoder_gen5/internal/radar_gen5_X391_definitions/dsp_LocationInterface_X391.hpp>

namespace radar_locations_decoder_gen5 {


RadarLocationDataGen5 RadarLocationsDecoderImplX391::decodeROBs(const uint8_t *data) const
{
    const X391::Dsp::LocationInterface *buf_dsp_location_data_p = (const X391::Dsp::LocationInterface *)data;
