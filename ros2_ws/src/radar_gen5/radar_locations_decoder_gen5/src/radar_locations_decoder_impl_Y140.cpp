...
#include <radar_locations_decoder_gen5/internal/radar_gen5_Y140_definitions/dsp_LocationInterface_Y140.hpp>

namespace radar_locations_decoder_gen5 {


RadarLocationDataGen5 RadarLocationsDecoderImplY140::decodeROBs(const uint8_t *data) const
{
  const Y140::Dsp::LocationInterface *buf_dsp_location_data_p = (const Y140::Dsp::LocationInterface *)data;
