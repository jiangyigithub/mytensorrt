//
// File: ekf_6D_CA_state2meas_obj_offset.cpp
//
...
// Return Type  : void
//
void ekf_6D_CA_state2meas_obj_offset(const double state_vector[6], double
  ...
  double y_offset_obj, double obj_orntn, double measurement[3])
{
  ...
  py_sensor = (state_vector[3] + (-x_offset_obj * py_sensor + y_offset_obj *
    range)) - sens_offset_y;
  ...
  measurement[2] = ((state_vector[1] - vx_ego) * px_sensor + state_vector[4] *
                    py_sensor) / range;
}

//
// File trailer for ekf_6D_CA_state2meas_obj_offset.cpp
//
// [EOF]
//
