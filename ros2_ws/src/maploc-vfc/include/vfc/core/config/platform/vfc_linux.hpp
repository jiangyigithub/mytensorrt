...
*     $Source: vfc_linux.hpp $
*     $Revision: 1.4 $
*     $Author: Jaeger Thomas (CC-DA/ENV1) (jat2hi) $
*     $Date: 2006/10/06 13:14:16MESZ $
*     $Locker:  $
...
#ifndef VFC_LINUX_HPP_INCLUDED
#define VFC_LINUX_HPP_INCLUDED

////////////////////////////////////
// linux specific config options
////////////////////////////////////

#define VFC_PLATFORM_STRING "linux"

#ifndef VFC_PLATFORM_LINUX
#   define VFC_PLATFORM_LINUX
#endif


// add more config code here ...

#endif //VFC_LINUX_HPP_INCLUDED
...
|-------------------------------------------------------------------|
$Log: vfc_linux.hpp  $
Revision 1.4 2006/10/06 13:14:16MESZ Jaeger Thomas (CC-DA/ENV1) (jat2hi) 
- changed VFC_PLATFORM define to VFC_PLATFORM_STRING
- added define VFC_PLATFORM_LINUX
(mantis 1149)
Revision 1.3 2005/10/28 10:17:40CEST Zitzewitz Henning von (CR/AEM5) (ZVH2HI) 
Initial revision
...
Revision 1.2 2005/10/06 17:00:49CEST Zitzewitz Henning von (CR/AEM5) * (ZVH2HI) 
Initial revision
