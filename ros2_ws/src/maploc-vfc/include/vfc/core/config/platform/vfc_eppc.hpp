...
#ifndef VFC_EPPC_HPP_INCLUDED
#define VFC_EPPC_HPP_INCLUDED

////////////////////////////////////
// win32 specific config options
////////////////////////////////////

#define VFC_PLATFORM_STRING "eppc"

#ifndef VFC_PLATFORM_EPPC
#   define VFC_PLATFORM_EPPC
#endif

// add more config code here ...

#endif //VFC_EPPC_HPP_INCLUDED
...
|-------------------------------------------------------------------|
$Log: vfc_eppc.hpp  $
Revision 1.4 2006/10/06 13:14:03MESZ Jaeger Thomas (CC-DA/ENV1) (jat2hi) 
- changed VFC_PLATFORM define to VFC_PLATFORM_STRING
- added define VFC_PLATFORM_EPPC
(mantis 1149)
Revision 1.3 2005/10/28 10:17:50CEST Zitzewitz Henning von (CR/AEM5) (ZVH2HI) 
Initial revision
...
Revision 1.2 2005/10/06 17:01:04CEST Zitzewitz Henning von (CR/AEM5) * (ZVH2HI) 
Initial revision
