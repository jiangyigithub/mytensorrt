...
///     $Source: vfc_linalg_vectorbase_dyn.inl $
///     $Revision: 1.1 $
///     $Author: Jaeger Thomas (CC-DA/EPV2) (jat2hi) $
///     $Date: 2007/05/09 10:21:30MESZ $
///     $Locker:  $
...
vfc::linalg::TVectorBase<ValueType, DerivedType, 
    vfc::linalg::CDynamicRectangle>::operator[] 
    (size_type f_row) const
{
...
inline vfc::int32_t
vfc::linalg::TVectorBase<ValueType, DerivedType, 
    vfc::linalg::CDynamicRectangle>::getDim(void) const
{
    const derived_type* me = static_cast<const derived_type*>(this);
    return me->getDim();
}
...
//-----------------------------------------------------------------------------
//  $Log: vfc_linalg_vectorbase_dyn.inl  $
//  Revision 1.1 2007/05/09 10:21:30MESZ Jaeger Thomas (CC-DA/EPV2) (jat2hi) 
//  Initial revision
