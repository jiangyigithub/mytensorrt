...
inline
vfc::linalg::TVector2<ValueType>::TVector2(
    const ValueType& f_value0_r, const ValueType& f_value1_r) 
    : TVectorN<ValueType, 2>()
{
...
inline
vfc::linalg::TVector2<ValueType>::TVector2(
    const TVector2<ValueType>& f_param_r)
...
inline
vfc::linalg::TVector2<ValueType>::TVector2(
    const TVectorN<ValueType, 2>& f_param_r)
    : TVectorN<ValueType, 2>(f_param_r)
{
}
...
template <class ValueType>
inline
void vfc::linalg::TVector2<ValueType>::set(
    const ValueType& f_value0_r, const ValueType& f_value1_r) 
{
    operator[](0) = f_value0_r;
    operator[](1) = f_value1_r;
