...
vfc::linalg::intern::TExp1D<ValueType, 
    ...
    vfc::linalg::CDynamicRectangle>
vfc::linalg::subView(
    const TVectorBase<ValueType, VectorType, ShapeType>& f_src_r,
    vfc::int32_t f_pos0, 
    vfc::int32_t f_count)
{
    return intern::TExp1D<ValueType, 
        ...
        vfc::linalg::CDynamicRectangle>(
            intern::TExp1DSubViewFrom1DOp<ValueType,
                TVectorConstRef<ValueType, VectorType, ShapeType>,
                vfc::linalg::CDynamicRectangle>(f_src_r, f_pos0, f_count));
}
...
vfc::linalg::intern::TExp1D<ValueType, 
    ...
    vfc::linalg::CDynamicRectangle>
vfc::linalg::subView(
    const intern::TExp1D<ValueType, OperatorType, ShapeType>& f_src_r,
    vfc::int32_t f_pos0, 
    vfc::int32_t f_count)
{
    return intern::TExp1D<ValueType, 
