...
inline
vfc::linalg::TVector4<ValueType>::TVector4(
    const TVectorN<ValueType, 4>& f_param_r)
    : TVectorN<ValueType, 4>(f_param_r)
{
}
...
template <class ValueType>
inline
void vfc::linalg::TVector4<ValueType>::set(
    const ValueType& f_value0_r, const ValueType& f_value1_r,
    const ValueType& f_value2_r, const ValueType& f_value3_r) 
{
    operator[](0) = f_value0_r;
