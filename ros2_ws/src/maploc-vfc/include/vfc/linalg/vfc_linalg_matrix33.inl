...
///     $Source: vfc_linalg_matrix33.inl $
///     $Revision: 1.1 $
...
inline
vfc::linalg::TMatrix33<ValueType>::TMatrix33(
...
inline
vfc::linalg::TMatrix33<ValueType>::TMatrix33(
    const TMatrix33<ValueType>& f_param_r)
...
inline
vfc::linalg::TMatrix33<ValueType>::TMatrix33(
    const TMatrixMN<ValueType, 3, 3>& f_param_r)
    : TMatrixMN<ValueType, 3, 3>(f_param_r)
{
}
...
template <class ValueType>
inline
void vfc::linalg::TMatrix33<ValueType>::set(
    const ValueType& f_value00_r, const ValueType& f_value01_r,
    const ValueType& f_value02_r, const ValueType& f_value10_r,
    const ValueType& f_value11_r, const ValueType& f_value12_r,
    const ValueType& f_value20_r, const ValueType& f_value21_r,
