...
///     $Source: vfc_linalg_matrix22.inl $
///     $Revision: 1.1 $
...
inline
vfc::linalg::TMatrix22<ValueType>::TMatrix22(
    const TMatrix22<ValueType>& f_param_r)
...
inline
vfc::linalg::TMatrix22<ValueType>::TMatrix22(
    const TMatrixMN<ValueType, 2, 2>& f_param_r)
    : TMatrixMN<ValueType, 2, 2>(f_param_r)
{
}
...
template <class ValueType>
inline
void vfc::linalg::TMatrix22<ValueType>::set(
    const ValueType& f_value00_r, const ValueType& f_value01_r,
    const ValueType& f_value10_r, const ValueType& f_value11_r) 
{
    operator()(0, 0) = f_value00_r;
