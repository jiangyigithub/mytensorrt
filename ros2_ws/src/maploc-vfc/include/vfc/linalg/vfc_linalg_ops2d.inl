...
///     $Source: vfc_linalg_ops2d.inl $
///     $Revision: 1.1 $
///     $Author: Jaeger Thomas (CC-DA/EPV2) (jat2hi) $
///     $Date: 2007/07/02 13:12:39MESZ $
///     $Locker:  $
...
vfc::linalg::intern::TExp2D<ValueType, 
    vfc::linalg::intern::TExp2DSubMatrixOp<ValueType, 
        ...
        ShapeType>,
    ShapeType>
vfc::linalg::submatrix(
    const vfc::linalg::TMatrixBase<ValueType, MatrixType, ShapeType>& f_src_r, 
    vfc::int32_t f_row0, vfc::int32_t f_col0,
    vfc::int32_t f_row1, vfc::int32_t f_col1)
{
    VFC_REQUIRE(((f_row1-f_row0) < f_src_r.getNbRows()) && \
        ((f_col1-f_col0) < f_src_r.getNbColumns()) && \
        (f_row0 < f_row1) && (f_col0<f_col1));
    return intern::TExp2D<ValueType, 
        ...
        ShapeType>(
            intern::TExp2DSubMatrixOp<ValueType, 
                TMatrixConstRef<ValueType, MatrixType, ShapeType>,
                ShapeType>(f_src_r, f_row0, f_col0, f_row1, f_col1));
}
...
vfc::linalg::intern::TExp2D<ValueType, 
    ...
    ShapeType>
vfc::linalg::submatrix(
    const vfc::linalg::intern::TExp2D<ValueType, OperatorType, ShapeType>& f_src_r, 
    vfc::int32_t f_row0, vfc::int32_t f_col0,
    vfc::int32_t f_row1, vfc::int32_t f_col1)
{
    VFC_REQUIRE(((f_row1-f_row0) < f_src_r.getNbRows()) && \
...
//-----------------------------------------------------------------------------
//  $Log: vfc_linalg_ops2d.inl  $
//  Revision 1.1 2007/07/02 13:12:39MESZ Jaeger Thomas (CC-DA/EPV2) (jat2hi) 
//  Initial revision
