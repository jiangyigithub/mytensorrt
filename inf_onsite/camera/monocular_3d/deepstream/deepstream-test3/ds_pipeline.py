...
def pgie_src_pad_buffer_probe(pad,info,u_data):
    ...
    while l_frame is not None:
        ...
        l_usr = frame_meta.obj_meta_list
        ...
        while l_usr is not None:
            ...
            try:
                    ...
                    #     print(f'wwww-output layer: {layer.layerName}')
...
def main(args, requested_pgie=None, config=None, disable_probe=False):
    ...
    if requested_pgie == "nvinferserver" and config != None:
        ...
        pgie.set_property('config-file-path', "dstest3_pgie_config_test.txt")
