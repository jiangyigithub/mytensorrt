...
import os
os.environ["GST_DEBUG_DUMP_DOT_DIR"] = "/home/icv/workspaces/inf_onsite/camera/monocular_3d/deepstream/deepstream-test3/debug"
os.putenv('GST_DEBUG_DUMP_DIR_DIR', '/home/icv/workspaces/inf_onsite/camera/monocular_3d/deepstream/deepstream-test3/debug')
...
class MC3dObjDet_Publisher(Node):
    ...
    def pgie_src_pad_buffer_probe(self,pad,info,u_data):
        ...
        while l_frame is not None:
            ...
            while l_obj is not None:
                ...
                # obj_det.yaw = -obj_det.yaw+0.03 # hongye south
                ...
                # workaround method for oritention issue
    ...
    def __init__(self):
        ...
        self.parse_args()
        global perf_data
        self.args = list(['rtsp://service:Icv%24%241234@192.168.0.1'])
        # self.args = list(['file:////home/icv/workspaces/wheel/test_video.mp4'])
