...
import os
import sys
sys.path.append('/home/icv-ai/workspaces/inf_sense/src/camera/monocular_3d/infrastructure3dobjectdetection/baseline_methods/lib/helpers')
...
def projection_init(camera_pose):
    ...
    K = np.array([[1451.25488, 0.000000  , 960],
                  [0.000000  , 1452.82479, 540],
                  [0.000000  , 0.000000  , 1.000000  ]])  # hongye west
    
    # K = np.array([[1439.96128, 0.000000  , 1120.00946],
    #               [0.000000  , 1442.95208, 690.35747],
    #               [0.000000  , 0.000000  , 1.000000  ]])  #hongye south
    # K = np.array([[1439.96128, 0.000000  , 960],
    #               [0.000000  , 1442.95208, 540],
    #               [0.000000  , 0.000000  , 1.000000  ]])  #hongye south

    # K = np.array([[1435.15095, 0.000000  , 1120.55688],
    #               [0.000000  , 1437.52563, 687.443565],
    #               [0.000000  , 0.000000  , 1.000000  ]])  #hongye north
    # K = np.array([[1435.15095, 0.000000  , 960],
    #               [0.000000  , 1437.52563, 540],
    #               [0.000000  , 0.000000  , 1.000000  ]])  #hongye north
