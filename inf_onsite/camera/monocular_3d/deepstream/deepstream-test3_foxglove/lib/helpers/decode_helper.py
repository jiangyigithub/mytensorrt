...
def extract_dets_from_outputs(outputs, K=50):
    ...
    # print("offset_2d:  ",offset_2d.shape)
    ...
    # print("xs2d: ",xs2d.shape)
    # print("ys2d: ",ys2d.shape)
    # print("size_2d: ",size_2d.shape)
    # print("depth: ",depth.shape)
    # print("heading: ",heading.shape)
    # print("size_3d: ",size_3d.shape)
    # print("xs3d: ",xs3d.shape)
    # print("ys3d: ",ys3d.shape)
...
def _topk(heatmap, K=50):
    ...
    # print("zzzzz",(heatmap).shape)
    # print("xxxx",(heatmap.view(batch, cat, -1)).shape)
    ...
    # print("topk_inds: ",topk_inds.shape)
    topk_ys = _gather_feat(topk_ys.view(batch, -1, 1), topk_ind).view(batch, K)
    topk_xs = _gather_feat(topk_xs.view(batch, -1, 1), topk_ind).view(batch, K)

    # print("topk_score: ", topk_score.shape)
    # print("topk_inds: ", topk_inds.shape)
    # print("topk_cls_ids: ", topk_cls_ids.shape)
