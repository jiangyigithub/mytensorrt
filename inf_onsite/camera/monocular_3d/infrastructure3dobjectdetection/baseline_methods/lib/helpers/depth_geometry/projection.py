...
import os
import sys
sys.path.append('/home/icv/code/workspaces/inf_onsite/camera/monocular_3d/infrastructure3dobjectdetection/baseline_methods/lib/helpers')
...
def projection_init(camera_pose):
    ...
    count = 0
    for Test_x in range(-100, 100, 1):
        for Test_y in range(-100, 100, 1):
            # print(Test_y)
            # print(count)
